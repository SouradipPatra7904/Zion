...
public class KafkaConfig {
    ...
    public ProducerFactory<String, Object> producerFactory() {
        Map<String, Object> producer_props = new HashMap<>();
        ...
        return new DefaultKafkaProducerFactory<>(producer_props);
    }
    ...
    public ConsumerFactory<String, Object> consumerFactory() {
        Map<String, Object> consumer_props = new HashMap<>();
        ...
        consumer_props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, JsonDeserializer.class);
        consumer_props.put(ConsumerConfig.GROUP_ID_CONFIG, "zion-read");
        consumer_props.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "earliest");

        return new DefaultKafkaConsumerFactory<>(consumer_props);
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, String> kafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, String> ckl_factory = 
        new ConcurrentKafkaListenerContainerFactory<String, String>();
        ckl_factory.setConsumerFactory(consumerFactory());
        return ckl_factory;
    }
}
